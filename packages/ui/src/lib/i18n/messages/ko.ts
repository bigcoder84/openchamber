...
export const dict: Record<I18nKey, string> = {
  ...
  'mobile.android.edit.title': '서버 편집',
  'mobile.android.edit.description': '저장된 서버 정보를 업데이트합니다. 저장한 변경 사항은 다음 연결부터 사용됩니다.',
  ...
  'mobile.android.action.edit': '편집',
  'mobile.android.action.save': '저장',
  'mobile.android.action.cancelEdit': '편집 취소',
  ...
  'mobile.android.health.openAria': '서버 전환 열기',
