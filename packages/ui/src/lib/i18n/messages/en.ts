...
export const dict = {
  ...
  'mobile.android.edit.title': 'Edit server',
  'mobile.android.edit.description': 'Update the saved server details. Saved changes apply the next time you connect.',
  ...
  'mobile.android.action.edit': 'Edit',
  'mobile.android.action.save': 'Save',
  'mobile.android.action.cancelEdit': 'Cancel edit',
  ...
  'mobile.android.health.openAria': 'Open server switcher',
