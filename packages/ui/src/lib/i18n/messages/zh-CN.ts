...
export const dict: Record<I18nKey, string> = {
  ...
  'mobile.android.edit.title': '编辑服务端',
  'mobile.android.edit.description': '更新已保存的服务端信息。保存后，下次连接会使用新的配置。',
  ...
  'mobile.android.action.edit': '编辑',
  'mobile.android.action.save': '保存',
  'mobile.android.action.cancelEdit': '取消编辑',
  ...
  'mobile.android.health.openAria': '打开服务端切换',
