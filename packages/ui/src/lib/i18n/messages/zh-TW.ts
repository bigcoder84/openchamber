...
export const dict: Record<I18nKey, string> = {
  ...
  'mobile.android.edit.title': '編輯服務端',
  'mobile.android.edit.description': '更新已儲存的服務端資訊。儲存後，下次連線會使用新的設定。',
  ...
  'mobile.android.action.edit': '編輯',
  'mobile.android.action.save': '儲存',
  'mobile.android.action.cancelEdit': '取消編輯',
  ...
  'mobile.android.health.openAria': '開啟服務端切換',
